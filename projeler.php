...
<section class="page-head">
  <div class="container">
    <h1>Başarılarımız</h1>
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item active">Başarılarımız</li></ol></nav>
  </div>
</section>
...
<section>
  <div class="container">
    <div class="section-head">
      <span class="badge-mini">Başarılarımız</span>
      <h2>Başarı & Kampüs <span>Galerimiz</span></h2>
    </div>
